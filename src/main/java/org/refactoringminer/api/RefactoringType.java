...
public enum RefactoringType {
	...
	ADD_PARAMETER_TYPE_ANNOTATION("Add Parameter Type Annotation", "Add Parameter Type Annotation (.+) in parameter (.+) in method (.+) from class (.+)"),
	REMOVE_PARAMETER_TYPE_ANNOTATION("Remove Parameter Type Annotation", "Remove Parameter Type Annotation (.+) in parameter (.+) in method (.+) from class (.+)"),
	ADD_RETURN_TYPE_ANNOTATION("Add Return Type Annotation", "Add Return Type Annotation (.+) in method (.+) from class (.+)"),
	REMOVE_RETURN_TYPE_ANNOTATION("Remove Return Type Annotation", "Remove Return Type Annotation (.+) in method (.+) from class (.+)"),
	CHANGE_PARAMETER_TYPE_ANNOTATION("Change Parameter Type Annotation", "Change Parameter Type Annotation (.+) to (.+) in parameter (.+) in method (.+) from class (.+)"),
	CHANGE_RETURN_TYPE_ANNOTATION("Change Return Type Annotation", "Change Return Type Annotation (.+) to (.+) in method (.+) from class (.+)"),
	...
	ADD_VARIABLE_TYPE_ANNOTATION("Add Variable Type Annotation", "Add Variable Type Annotation (.+) in (attribute|variable) (.+) (from class|in method .+ from class) (.+)"),
	REMOVE_VARIABLE_TYPE_ANNOTATION("Remove Variable Type Annotation", "Remove Variable Type Annotation (.+) in (attribute|variable) (.+) (from class|in method .+ from class) (.+)"),
	CHANGE_VARIABLE_TYPE_ANNOTATION("Change Variable Type Annotation", "Change Variable Type Annotation (.+) to (.+) in (attribute|variable) (.+) (from class|in method .+ from class) (.+)"),
	...
	public static RefactoringType[] ALL = {
		...
		REMOVE_PARAMETER_TYPE_ANNOTATION,
		ADD_RETURN_TYPE_ANNOTATION,
		REMOVE_RETURN_TYPE_ANNOTATION,
		CHANGE_PARAMETER_TYPE_ANNOTATION,
		CHANGE_RETURN_TYPE_ANNOTATION,
		ADD_VARIABLE_TYPE_ANNOTATION,
		REMOVE_VARIABLE_TYPE_ANNOTATION,
		CHANGE_VARIABLE_TYPE_ANNOTATION,
