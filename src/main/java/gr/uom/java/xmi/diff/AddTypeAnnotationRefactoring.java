...
public class AddTypeAnnotationRefactoring implements MethodLevelRefactoring {
	...
	/**
	 * For ADD_PARAMETER_TYPE_ANNOTATION: parameterName is the name of the annotated parameter.
	 * For ADD_RETURN_TYPE_ANNOTATION: parameterName should be null.
	 */
	public AddTypeAnnotationRefactoring(RefactoringType type, String annotatedType, String parameterName,
	...
	public List<CodeRange> rightSide() {
		...
		ranges.add(operationAfter.codeRange()
				.setDescription("method declaration with added type annotation")
	...
	public String toString() {
		...
		sb.append(annotatedType);
		if (type == RefactoringType.ADD_PARAMETER_TYPE_ANNOTATION || type == RefactoringType.REMOVE_PARAMETER_TYPE_ANNOTATION) {
	...
	public boolean equals(Object obj) {
		...
		AddTypeAnnotationRefactoring other = (AddTypeAnnotationRefactoring) obj;
		if (type != other.type) return false;
		if (annotatedType == null ? other.annotatedType != null : !annotatedType.equals(other.annotatedType)) return false;
