...
public class ReplacePatternMatchingWithConditionalRefactoring implements MethodLevelRefactoring {
	...
	public ReplacePatternMatchingWithConditionalRefactoring(Set<AbstractCodeFragment> codeFragmentsBefore,
	...
	public String toString() {
		...
		AbstractCodeFragment matchFragment = codeFragmentsBefore.iterator().next();
	...
	public List<CodeRange> rightSide() {
		...
		for (AbstractCodeFragment fragment : codeFragmentsAfter) {
			ranges.add(fragment.codeRange()
					.setDescription("conditional code")
					.setCodeElement(fragment.getString()));
		}
		String elementType = operationAfter.getElementType();
		ranges.add(operationAfter.codeRange()
				.setDescription(elementType + " declaration with introduced conditional")
	...
	public RefactoringType getRefactoringType() {
		return RefactoringType.REPLACE_PATTERN_MATCHING_WITH_CONDITIONAL;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReplacePatternMatchingWithConditionalRefactoring other = (ReplacePatternMatchingWithConditionalRefactoring) obj;
