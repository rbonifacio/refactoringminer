...
public class AddVariableTypeAnnotationRefactoring implements MethodLevelRefactoring {
	...
	public AddVariableTypeAnnotationRefactoring(RefactoringType type, VariableDeclaration variableBefore, VariableDeclaration variableAfter,
	...
	public String toString() {
		...
		boolean isRemove = type == RefactoringType.REMOVE_VARIABLE_TYPE_ANNOTATION;
		sb.append(isRemove ? variableBefore.getType().toString() : variableAfter.getType().toString());
	...
	public List<CodeRange> rightSide() {
		...
		ranges.add(variableAfter.codeRange()
				.setDescription("variable declaration with added type annotation")
				.setCodeElement(variableAfter.toString()));
		String elementType = operationAfter.getElementType();
		ranges.add(operationAfter.codeRange()
				.setDescription(elementType + " declaration with added variable type annotation")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AddVariableTypeAnnotationRefactoring other = (AddVariableTypeAnnotationRefactoring) obj;
